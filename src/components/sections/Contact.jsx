  ...
  const contactInfo = [
    {
      ...
      content: <span className="contact-text">bendronedu@<br className="contact-break"/>gmail.com</span>,
    ...
    <section id="contact" className="section relative overflow-hidden">
      <div className="container-custom relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-8 xl:gap-10 items-start">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-1 2xl:grid-cols-2 gap-4 animate-fade-in-left delay-200">
