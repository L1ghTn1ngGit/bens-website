...
const heroImages = [
  { src: '/assets/images/about/ben-un-2-md.jpg', alt: 'Benjamin at the UN', labelKey: 'benjaminDron', base: '/assets/images/about/ben-un-2', pos: 'center 55%' },
  { src: '/assets/images/about/ben-un-main-md.jpg', alt: 'Benjamin Dron at the UN', labelKey: 'unYouthDelegate', base: '/assets/images/about/ben-un-main', pos: 'center 30%' },
  { src: '/assets/images/about/ben-activity-3-md.jpg', alt: 'Benjamin aviation experience', labelKey: 'aviation', base: '/assets/images/about/ben-activity-3', pos: 'center center' },
  { src: '/assets/images/about/ben-activity-1-md.jpg', alt: 'Benjamin in activities', labelKey: 'un', base: '/assets/images/about/ben-activity-1', pos: 'center center' },
  { src: '/assets/images/about/ben-band-md.jpg', alt: 'Benjamin in band', labelKey: 'band', base: '/assets/images/about/ben-band', pos: 'center 30%' },
]
